...
// KaseiCoinCrowdsale contract that inherits the following from OpenZeppelin:
// * Crowdsale
// * MintedCrowdsale
contract KaseiCoinCrowdsale is Crowdsale, MintedCrowdsale { // UPDATE THE CONTRACT SIGNATURE TO ADD INHERITANCE
    
    // Provide parameters for crowdsale features.
    constructor(
        uint rate,
...
// Crowdsale deployer contract with public address variables
